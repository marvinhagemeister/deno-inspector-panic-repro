...
import type { BuildOptions, Plugin as EsbuildPlugin } from "npm:esbuild@0.25.7";
...
let esbuild: null | typeof import("npm:esbuild@0.25.7") = null;
...
export async function startEsbuild() {
  esbuild = Deno.env.get("FRESH_ESBUILD_LOADER") === "portable"
    ? await import("npm:esbuild-wasm@0.25.7")
    : await import("npm:esbuild@0.25.7");
