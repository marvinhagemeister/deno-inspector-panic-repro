/** @jsxRuntime classic *//** @jsxImportSource npm:preact@^10.27.0 *//** @jsxImportSourceTypes npm:preact@^10.27.0 *//** @jsxFactory React.createElement *//** @jsxFragmentFactory React.Fragment */import {
  type Component,
  ...
  type VNode,
} from "npm:preact@^10.27.0";
import type { ReadonlySignal, Signal } from "npm:@preact/signals@^2.2.1";
...
import { escape as escapeHtml } from "jsr:@std/html@1";
